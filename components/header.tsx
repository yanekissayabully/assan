...
//             <button className="text-[12px] text-[var(--gov-gray)] hover:text-[var(--gov-green)] transition-colors">
//               Перейти в режим для слабовидящих
//             </button>
//             {/* User button */}
//             <button className="flex items-center gap-1 bg-[var(--gov-green-dark)] text-white px-3 py-1.5 text-[12px] font-medium h-8">
//               <span className="w-4 h-4 rounded-full bg-white/30 flex items-center justify-center text-[10px] mr-1">
...
//               <span className="text-[var(--gov-green-dark)] font-bold text-2xl leading-none tracking-tight">
//                 e<span className="text-[var(--gov-green-dark)]">.</span>gov
//               </span>
//             </div>
//             <div className="leading-tight ml-1 border-l border-[var(--gov-border)] pl-3">
...
//                 <Search size={16} className="text-[var(--gov-gray)]" />
//               </button>
//             </div>
//           </div>
...
//               <div className="text-[32px] font-bold text-[var(--gov-green-dark)] leading-none">1414</div>
//               <div className="text-[11px] text-[var(--gov-gray)] mt-0.5">Единый контакт-центр</div>
//             </div>
//             <div className="text-[11px] text-[var(--gov-gray)] leading-relaxed pt-1">
//               <div>Звонок бесплатный</div>
//               <div>Звонок платный</div>
//               <div>для зарубежных звонков</div>
//               <div className="text-[var(--gov-green)] hover:underline cursor-pointer">(бесплатно через интернет)</div>
//             </div>
//           </div>

//           <div className="text-[13px] text-[var(--gov-gray)] hidden lg:block ml-2">
//             <div className="font-medium">+7 7172 906 984</div>
//           </div>
