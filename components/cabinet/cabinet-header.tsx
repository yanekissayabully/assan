...
// //       <div className="max-w-[1200px] mx-auto px-4 flex items-center h-11 gap-0">
// //         {/* Logo */}
// //         <a href="/" className="shrink-0 mr-6">
// //           <span className="text-[var(--gov-green-dark)] font-bold text-xl leading-none tracking-tight">
...
// //               key={tab.label}
// //               href={tab.href}
// //               className={`relative flex items-center gap-1 px-3 h-full text-[13px] whitespace-nowrap transition-colors ${
// //                 tab.active
