...
//         <h2 className="text-[15px] font-normal text-[var(--gov-teal)]">
//           {title}
//           {hasServices && (
//             <span className="text-[var(--gov-teal)]"> | Услуги</span>
//           )}
//           {hasDropdown && <ChevronDown size={14} className="inline ml-1 text-[var(--gov-teal)]" />}
//         </h2>
//         <RefreshCw size={12} className="text-[var(--gov-gray)] cursor-pointer hover:text-[var(--gov-teal)]" />
...
//       <span className="font-medium text-[var(--gov-teal)]">{label}:</span>{' '}
//       <span className={teal ? 'text-[var(--gov-teal)]' : 'text-[var(--gov-text)]'}>{value}</span>
//     </div>
//   )
// }
...
//       <a href="#" className="text-[var(--gov-teal)] underline">сюда</a>
//     </div>
//   )
// }

// function Separator() {
//   return <div className="text-[var(--gov-green-100)] text-[13px] my-4 ml-1">◆◆◆</div>
// }
...
//       <div className="flex justify-between text-[11px] text-[var(--gov-gray)] mb-1">
//         <span>{start}</span>
//         <span className="text-[var(--gov-gray)]">{years}</span>
//         <span className="text-[#e53935]">{end}</span>
//       </div>
//       <div className="relative h-2 rounded-full overflow-hidden" style={{ background: 'linear-gradient(to right, #4caf50, #ffb300, #e53935)' }}>
//         <div
//           className="absolute top-0 w-2 h-2 rounded-full bg-white border-2 border-[var(--gov-green-dark)]"
//           style={{ left: `calc(${position}% - 4px)` }}
//         />
//       </div>
//       <div className="text-[11px] text-[var(--gov-gray)] mt-1" style={{ marginLeft: `${position}%` }}>Сегодня</div>
//     </div>
//   )
// }
...
//   return (
//     <div className="flex-1 px-6 py-4 max-w-[900px]">
//       {/* Personal header */}
//       <div className="flex items-center gap-2 text-[12px] text-[var(--gov-gray)] mb-3">
//         <RefreshCw size={12} />
//         <span>6 минут назад</span>
//       </div>
//       <h1 className="text-[18px] font-normal text-[var(--gov-text)] mb-3 uppercase tracking-wide">
//         АСАНОВ БАУЫРЖАН ИСЛАМОВИЧ
//       </h1>
//       <div className="grid grid-cols-2 gap-x-8 gap-y-1 mb-2">
//         <div>
//           <Field label="ИИН" value="920510300400" />
//           <Field label="Дата рождения" value="10 мая 1992" />
...
//             <span className="font-medium text-[var(--gov-teal)]">E-mail:</span>
//             <span className="text-[var(--gov-text)]">marala.90@mail.ru</span>
//             <button className="text-[var(--gov-gray)] hover:text-[var(--gov-teal)]"><Pencil size={12} /></button>
//           </div>
//           <div className="flex items-center gap-2 text-[13px] mt-1">
//             <span className="font-medium text-[var(--gov-teal)]">Телефон:</span>
//             <span className="text-[var(--gov-text)]">+7 (705) 807-44-57</span>
//             <button className="text-[var(--gov-gray)] hover:text-[var(--gov-teal)]"><Pencil size={12} /></button>
//             <button className="text-[#e53935]"><X size={12} /></button>
//           </div>
//           <div className="text-[11px] text-[var(--gov-gray)] mt-1 leading-snug max-w-[280px]">
...
//         <span className="text-[13px] text-[var(--gov-teal)] cursor-pointer hover:underline ml-1">Моё местоположение</span>
//         <div className="mt-2">
//           <Card>
//             <Field label="Место рождения" value="КАЗАХСТАН , ОБЛАСТЬ ЖЕТИСУ область , ТАЛДЫКОРГАН" />
//           </Card>
//           <Card>
//             <div className="text-[13px] font-medium text-[var(--gov-teal)] mb-1">Адрес прописки:</div>
//             <div className="text-[13px] text-[var(--gov-text)] leading-relaxed">
...
//       {/* 3. Водительское */}
//       <div id="driver">
//         <SectionHeader title="Водительское удостоверение" hasServices updated="11.06.26" hasDropdown />
//         <Card>
...
//         <Card title="ТЛЕУЛЕСОВА АЙГЕРИМ СЕРИКОВНА">
//           <Field label="ЗАГС" value="" />
//           <div className="text-[13px] text-[var(--gov-teal)] leading-snug mb-1">
//             ГУ Отдел занятости, социальных программ и регистрации актов гражданского состояния г.Талдыкорган
//           </div>
//           <Field label="ИИН супруги" value="940414400290" />
//           <Field label="Фамилия супруги до регистрации заключения брака" value="Тлеулесова" />
//         </Card>
//         <WrongDataNote />
//         <Separator />
//       </div>
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">Вам не присвоен социальный статус.</p>
//         <Separator />
//       </div>
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">Вы не владеете имуществом.</p>
//         <WrongDataNote />
//         <div className="mt-2">
//           <div className="flex items-center gap-2">
//             <span className="text-[14px] text-[var(--gov-teal)]">Земельные участки</span>
...
//       <div id="legal">
//         <SectionHeader title="Участие в юридических лицах (учредители, граждане - инициаторы, участники)" />
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">Вы не являетесь участником Юридического лица.</p>
//         <Separator />
//       </div>
...
//             <Field label="VIN код" value="MXHJC81EDSK022944" />
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">У вас отсутствуют лицензии.</p>
//         <Separator />
//       </div>
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">Вы отсутствуете в реестре должников</p>
//         <Separator />
//       </div>
...
//                   <td className="py-1.5 text-[var(--gov-text)]">{diag}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//           <Field label="Наименование работодателя" value="" />
//           <div className="text-[13px] text-[var(--gov-teal)] mb-1">Товарищество с ограниченной ответственностью "MultiBRAND COMPANY"</div>
...
//         </Card>
//         <Card>
//           <p className="text-[13px] text-[var(--gov-text)] leading-relaxed mb-3">
...
//           </p>
//           <button className="bg-[var(--gov-green-dark)] text-white text-[12px] px-4 py-1.5 hover:bg-[var(--gov-green-darker)] transition-colors">
//             Скачать справку
//           </button>
//         </Card>
//         <Card title="Примечание">
//           <p className="text-[13px] text-[var(--gov-text)]">
...
//           <Field label="Пенсионные накопления за счет ОПВ, находящиеся в доверительном управлении НБ РК, доступные для осуществления ЕПВ в целях улучшения жилищных условий и (или) оплаты лечения" value="" />
//           <div className="text-[13px] text-[var(--gov-text)] ml-[1px]">0.00</div>
//           <Field label="Пенсионные накопления, находящиеся в доверительном управлении НБ РК, доступные для передачи в доверительное управление УИП" value="" />
//           <Field label="за счет ОПВ" value="3,389,954.64" />
//           <p className="text-[13px] text-[var(--gov-text)] mt-2">
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">Вы не являетесь индивидуальным предпринимателем.</p>
//         <Separator />
//       </div>
...
//         <Card>
//           <Field label="Статус" value="Незастрахован" />
...
//         <a href="#" className="text-[13px] text-[var(--gov-teal)] underline ml-1">Проверить номер очереди по ИИН</a>
//         <Separator />
//       </div>
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">На момент проверки сведения об административных штрафах отсутствуют</p>
//         <Separator />
//       </div>
...
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">{'Сведения по Вам отсутствуют в ИС «Е-кызмет»'}</p>
//         <Separator />
//       </div>
...
//           <a href="#" className="text-[13px] text-[var(--gov-teal)] hover:underline">Регистрация карт</a>
//           <div className="mt-2 h-1 w-full bg-[var(--gov-border)] rounded" />
//         </div>
//         <Separator />
//       </div>
...
//         <h2 className="text-[15px] font-normal text-[var(--gov-teal)] mb-2">Взаимодействие с Правительством</h2>
...
//               <span className="text-[var(--gov-teal)] text-[13px] mt-0.5">○</span>
//               <a href="#" className="text-[13px] text-[var(--gov-teal)] hover:underline">{link}</a>
//             </li>
//           ))}
//         </ul>
//       </div>
...
//         <h2 className="text-[15px] font-normal text-[var(--gov-teal)]">
//           {title}
//           {hasServices && <span className="text-[var(--gov-teal)]"> | Услуги</span>}
//         </h2>
//         {hasDropdown && <ChevronDown size={14} className="text-[var(--gov-teal)] cursor-pointer" />}
//         {extra}
//         <RefreshCw size={12} className="text-[var(--gov-gray)] cursor-pointer hover:text-[var(--gov-teal)]" />
//         {updated && <span className="text-[11px] text-[var(--gov-gray)]">Обновлено: {updated}</span>}
//       </div>
...
//     <div className="text-[13px] leading-relaxed">
//       <span className="font-medium text-[var(--gov-teal)]">{label}:</span>{' '}
//       {value && <span className={teal ? 'text-[var(--gov-teal)]' : 'text-[var(--gov-text)]'}>{value}</span>}
//     </div>
//   )
// }
...
// function Separator() {
//   return <div className="text-[var(--gov-gray)] text-[11px] my-4 ml-1 tracking-widest">◆◆◆</div>
// }
...
//             <span className="font-medium text-[var(--gov-teal)]">E-mail:</span>
//             <span className="text-[var(--gov-text)]">marala.90@mail.ru</span>
//             <button className="text-[var(--gov-gray)] hover:text-[var(--gov-teal)]">
//               <Pencil size={12} />
//             </button>
//           </div>
//           <div className="flex items-center gap-2 text-[13px] mt-1">
...
//       {/* 2. Адреса — "Моё местоположение" is inline in the header row, like in screenshot */}
//       <div id="address">
//         <div className="mb-1">
//           <div className="flex items-center gap-2 flex-wrap">
//             <h2 className="text-[15px] font-normal text-[var(--gov-teal)]">Адреса</h2>
//             <RefreshCw size={12} className="text-[var(--gov-gray)] cursor-pointer hover:text-[var(--gov-teal)]" />
//             <a href="#" className="text-[13px] text-[var(--gov-gray)] hover:text-[var(--gov-teal)] hover:underline">
//               Моё местоположение
//             </a>
//             <span className="text-[11px] text-[var(--gov-gray)]">Обновлено: 11.06.26</span>
//           </div>
...
//         <SectionHeader title="Сведения о заключении брака" hasServices hasDropdown />
//         <Card title="ТЛЕУЛЕСОВА АЙГЕРИМ СЕРИКОВНА">
//           {/* ЗАГС label on its own line, value below as teal — matches screenshot */}
//           <div className="text-[13px] font-medium text-[var(--gov-teal)]">ЗАГС:</div>
//           <div className="text-[13px] text-[var(--gov-teal)] leading-snug mb-1">
//             ГУ Отдел занятости, социальных программ и регистрации актов гражданского состояния г.Талдыкорган
//           </div>
//           <Field label="ИИН супруги" value="940414400290" />
...
//       {/* 7. Участие в юридических лицах */}
//       <div id="legal">
//         {/* No "updated" on same line in screenshot — refresh is there but date below title */}
//         <div className="mb-1">
//           <div className="flex items-center gap-2 flex-wrap">
//             <h2 className="text-[15px] font-normal text-[var(--gov-teal)]">
...
//                 <tr key={i} className="border-b border-[var(--gov-border)] last:border-0">
//                   <td className="py-1.5 text-[var(--gov-gray)]" />
//                   {/* teal link colour matching screenshot */}
//                   <td className="py-1.5 text-[var(--gov-teal)]">{diag}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//         <SectionHeader title="Трудовая деятельность" />
//         <Card title="Трудовой договор № 13">
//           {/* Label on own line, employer name on next line in teal — matches screenshot */}
//           <div className="text-[13px] font-medium text-[var(--gov-teal)]">Наименование работодателя:</div>
//           <div className="text-[13px] text-[var(--gov-teal)] mb-1">
...
//         </Card>
//         <Card>
//           <p className="text-[13px] font-medium text-[var(--gov-teal)] leading-relaxed mb-3">
//             Для получения сведений о воинском учете (о месте состояния на воинском учете, отношении и степени годности к воинской службе, периодах прохождения воинской службы, предоставлении отсрочек (освобождении) от призыва на воинскую службу) нажмите на кнопку
//             {' '}
//             <button className="bg-[var(--gov-green-dark)] text-white text-[12px] px-4 py-1.5 ml-2 hover:bg-[var(--gov-green-darker)] transition-colors align-middle">
//               Скачать справку
//             </button>
//           </p>
//         </Card>
...
//           <Field label="Сумма пенсионных накоплений за счет ОПВ" value="6,779,909.28" />
//           <Field label="Порог минимальной достаточности, соответствующий возрасту вкладчика (получателя)" value="11,130,000.00" />
//           {/* Long label with value on next line */}
//           <div className="text-[13px] font-medium text-[var(--gov-teal)] leading-snug mt-0.5">
...
//           </div>
//           <div className="text-[13px] text-[var(--gov-text)] mb-0.5">0.00</div>
//           <div className="text-[13px] font-medium text-[var(--gov-teal)] leading-snug">
...
//         <SectionHeader title="Обязательное социальное медицинское страхование" />
//         <Card>
//           {/* "Статус: Незастрахован" — label bold teal, value normal dark — first row has bg in screenshot */}
//           <div className="text-[13px] leading-relaxed">
//             <span className="font-medium text-[var(--gov-teal)]">Статус:</span>{' '}
//             <span className="text-[var(--gov-text)]">Незастрахован</span>
//           </div>
//           <Field label="Вид последнего платежа" value="Взнос на обязательное социальное медицинское страхование (КНП = 122)" />
//           <Field label="Плательщик взноса" value="ТОО Galamat Media" teal />
//           <Field label="Наименование организации" value="ТОО Galamat Media" teal />
...
//       <div id="housing">
//         <SectionHeader title="Очередь на жилье" hasDropdown />
//         <a href="#" className="text-[13px] text-[var(--gov-teal)] underline ml-1">
...
//       <div id="fines">
//         <SectionHeader title="Административные штрафы" />
//         <p className="text-[13px] text-[var(--gov-text)] ml-1">
